...
def evaluate_model(model_type='standard', checkpoint_path=None, num_episodes=50, 
                   use_temporal_agg=False, query_frequency=1):
    """
    ...
    Args:
        ...
        query_frequency: How often to query the policy (1 = every step, 100 = once per episode)
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--query_freq', type=int, default=1, help='Query frequency (1=every step)')
